...
@section('content')
   <!-- Page Content -->
    <div class="page-content page-details" style="margin-top: 100px;">
        ...
        <div class="container">
            ...
            <div class="col-lg-2">
                <div class="row">
                <div class="col-3 col-lg-12 mt-3 mt-lg-0" v-for="(photo, index) in photos" :key="photo.id" data-aos="zoom-in" data-aos-delay="100">
        ...
        <section class="store-heading">
            ...
            <div class="row">
                ...
                <a href="cart.html" class="btn btn-success nav-link px-4 text-white btn-block mb-3">Add to Cart</a>
                </div>
            </div>
            </div>
        </section>
        ...
        <section class="store-review">
            ...
            <div class="row">
                ...
                <ul class="list-unstyled">
                    <li class="media">
                    <img src="/images/user-review-1.png" alt="" class="mr-3 rounded-circle">
                    ...
                    <li class="media">
                    <img src="/images/user-review-2.png" alt="" class="mr-3 rounded-circle">
                    <div class="media-body">
                    ...
                    <li class="media">
                    <img src="/images/user-review-3.png" alt="" class="mr-3 rounded-circle">
                    <div class="media-body">
